...
public partial class DrawEllipseToolSettings : UserControl
{
    public EllipseTool Tool { get; set; }

    public DrawEllipseToolSettings()
    {
        InitializeComponent();
    }

    public DrawEllipseToolSettings(EllipseTool tool) : this()
    {
        Tool = tool;
        UpdateSettings(tool.Settings);
    }

    private void UpdateSettings(EllipseTool.ToolSettings toolSettings)
    {
